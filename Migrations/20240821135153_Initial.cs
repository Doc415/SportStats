        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlayedAgainst = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OwnTeamId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MemberOfId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StatType = table.Column<string>(type: "nvarchar(13)", maxLength: 13, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Stats", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Stats_Games_InGameId",
                        column: x => x.InGameId,
                        principalTable: "Games",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Stats_Players_BelongsToId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Players_MemberOfId",
                table: "Players",
                column: "MemberOfId");

            migrationBuilder.CreateIndex(
                name: "IX_Stats_BelongsToId",
                table: "Stats",
                column: "BelongsToId");

            migrationBuilder.CreateIndex(
                name: "IX_Stats_InGameId",
                table: "Stats",
                column: "InGameId");
        }
